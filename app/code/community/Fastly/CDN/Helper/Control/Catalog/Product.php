...
class Fastly_CDN_Helper_Control_Catalog_Product extends Fastly_CDN_Helper_Data
{
    const XML_PATH_FASTLY_CDN_CACHE_PURGE  = 'fastlycdn/general/purge_catalog_product';

    /**
     * Returns true if Fastly CDN is enabled and product should be purged on save
     *
     * @return boolean
     */
