...
class Fastly_CDN_Model_Esi_Tag_Reports_Product_Viewed extends Fastly_CDN_Model_Esi_Tag_Abstract
{
    const COOKIE_NAME    = 'reports_product_viewed';
    const ESI_URL        = 'fastlycdn/esi/reports_product_viewed';
