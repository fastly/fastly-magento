...
sed -i "s/resp.http.Fastly-Magento-VCL-Uploaded = \".*\"/resp.http.Fastly-Magento-VCL-Uploaded = \"$VERSION\"/g" ./app/code/community/Fastly/CDN/etc/default.vcl ./app/code/community/Fastly/CDN/etc/vcl_snippets/*.vcl
