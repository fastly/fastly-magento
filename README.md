...
You need an account with [fastly.com](https://www.fastly.com/signup) which alows [uploading of custom VCL](https://docs.fastly.com/guides/vcl/uploading-custom-vcl). If you need
